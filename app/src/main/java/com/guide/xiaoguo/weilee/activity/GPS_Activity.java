...
//    private BitmapDescriptor mIconLocation;
    private TextView gps_b_time;
    private TextView gps_e_time;
    private Button done;
    private LinearLayout ll_gps_b_time;
    private LinearLayout ll_gps_e_time;
    ...
    private void initView() {
        ...
        gps_b_time = findViewById(R.id.gps_b_time);
        gps_b_time.setText(tools.getCurrentTime());
        gps_e_time = findViewById(R.id.gps_e_time);
        gps_e_time.setText(tools.getCurrentTime());
        ll_gps_b_time = findViewById(R.id.ll_gps_b_time);
        ll_gps_e_time = findViewById(R.id.ll_gps_e_time);
        gps_g_spinner = findViewById(R.id.gps_g_spinner);
        ...
        gps_d_spinner = findViewById(R.id.gps_d_spinner);
        ...
        check_RG = findViewById(R.id.check_RG);
    ...
    public void Dealwith() {
        ...
        ll_gps_b_time.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
//                tools.GetDataTime(GPS_Activity.this,gps_b_time.getText().toString(), gps_b_time);
            }
        });
        ll_gps_e_time.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
//                tools.GetDataTime(GPS_Activity.this,gps_b_time.getText().toString(), gps_e_time);
            }
        });
                    ...
                    if (Json.getString("message").equals("success")) {
                        ...
                        if (GPS_JA.length() >= 1) {
                            ...
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(GPS_Activity.this, "无数据！", Toast.LENGTH_LONG).show();
                                }
                            });
                        }
                    }
