package com.guide.xiaoguo.weilee.service;
...
import com.guide.xiaoguo.weilee.utils.Utils;
...
public class BleService extends Service {
	...
	private void broadcastUpdate(String action,
		...
		Log.i("0000000000000","broadcastUpdate: "+stringData);
		if (data != null && data.length > 0) {
			final StringBuilder stringBuilder = new StringBuilder(data.length);
			for (byte byteChar : data) {
				stringBuilder.append(String.format("%X", byteChar));
			}
			Log.i("0000000000", "broadcastUpdate: "+stringBuilder);
			if (stringData != null) {
			...
			Log.i("2222222222", "broadcastUpdate: "+notify_result);
			Log.i("2222222222", "broadcastUpdate: "+notify_result_length);
		}
	...
	public boolean init() {
		...
		bleSeviceFilter.addAction(Dialog_Activity.FIND_DEVICE_ALARM_ON);
		bleSeviceFilter.addAction(Dialog_Activity.CANCEL_DEVICE_ALARM);
